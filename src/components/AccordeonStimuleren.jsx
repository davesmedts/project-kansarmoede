      ...
      <Accordion open={open} toggle={toggle}>
        <AccordionItem>
          ...
          <AccordionBody accordionId="1">
            <p>Vanuit onderzoek wordt aangetoond dat kinderen uit allochtone en kansarme gezinnen regelmatig geconfronteerd worden met een ongelijke startpositie. Deze blijft doorwegen op hun onderwijstraject. Het schoolsysteem kan de ongelijke startpositie niet opvangen waardoor we niet kunnen werken naar gelijke kansen om de eindstreep te behalen. Het versterkt de sociale ongelijkheden. Maatschappelijk kwetsbaarheid bij kinderen en jongeren bevestigen dit. Voor veel kinderen en jongeren is de school een moeilijk parcours vol hindernissen dat uitsluit en kwetst. Het is net het tegenovergestelde van wat er bedoeld is (Het perspectief van maatschappelijke kwetsbare kinderen en jongeren in het onderwijsdebat: What do you think?, 2012).</p>
