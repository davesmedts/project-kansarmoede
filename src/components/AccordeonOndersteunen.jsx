      ...
      <Accordion open={open} toggle={toggle}>
        ...
        <AccordionItem>
          ...
          <AccordionBody accordionId="7">
            ...
            <p>Vanuit het opzet van de dienstverlening van de gelijke benadering, met de kijk op het verwezenlijken van sociale rechten, wordt er geen zekerheid geboden dat deze wordt beantwoord aan de verschillende noden en condities waarin en waarmee mensen leven. Men vindt het vanzelfsprekend dat in een gelijke benadering er voor iedereen een gelijke dienstverlening is en waarbij het ook een gelijke impact heeft voor iedereen. Dit is echter niet zo. Je vertrekt niet vanuit de meest kwetsbaren onder ons, maar vanuit wat mensen met elkaar verbindt. Het is een aanpak waarbij je afwisselend werkt met het oog op ongelijkheid tussen mensen en diversiteit.</p>
