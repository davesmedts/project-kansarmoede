        ...
        <Accordion open={open} toggle={toggle}>
          <AccordionItem>
            ...
            <ul>
                ...
                <li>Het ruimtelijk domein betreft het creëren van infrastructuur om de drempel richting de arbeidsmarkt te verlagen. Bijvoorbeeld openbaar vervoer, uitzendbureaus en opleidingen. </li>
            ...
            <p>Kinderen uit langdurige arme gezinnen met weinig opleiding, hangt samen in het domein privé met een geringe investering in kinderen, hun schoolcarrière en hun ontwikkeling. De ouders missen vaak de vaardigheden en hebben alsook zorgen en stress die komen kijken bij armoede. Ouders hebben vaak ook een andere attitude t.o.v. de ontwikkeling en het belang van school, hierdoor bemoeien ze zich minder met de opleiding van hun kinderen. Vervolgens leidt dit tot lagere schooladviezen. </p>
            ...
            <ul>
                <li>In het privédomein kan er gewerkt worden aan omgaan met conflicten. Hoogoplopende ruzies kunnen voorkomen worden en de gevolgen die nadelig zijn zoals stress en trauma’s hebben invloed op het aangaan van relaties in de toekomst. Hierbij kunnen we denken aan liefdesrelaties maar ook aan werkrelaties die verbetert kunnen worden. Hier leert men conflictsituaties niet te ontlopen en ontslag te nemen maar ze leren ermee omgaan en deze te hanteren. Het vergemakkelijkt carrièrestappen te maken en door deze weg kan langdurige armoede doorbroken worden. </li>
                ...
                <li>Goede opvangmogelijkheden horen daar ook bij, bij de werkgever of in de buurt. Dit heeft te maken met de ruimtelijk domein, infrastructuur. Het is ook van belang dat er een goede reisverbinding is tussen woonwerk en opvangplekken (Duurzame aanpak van kinderarmoede, 2022). </li>
            </ul>
            ...
            <ul>
                ...
                <li>Belangrijk en wat speelt in het ruimtelijk domein is de rol bij proactieve coping om stress te vinden. Buiten zijn en frisse lucht hebben, genieten van de natuur is heel belangrijk. Langdurige arme families leven vaak in een wijk of gebied van generatie op generatie. Dit zijn vaak wijken die minder groen zijn. Een natuurspeelplaats voor kinderen is dan belangrijk om stress kwijt te kunnen en daar kunnen ze goed spelen. Een park om tot rust te komen door te wandelen heeft ook een positief effect op ouders en kinderen en verlaagd het stressniveau. Het zijn gratis activiteiten (Duurzame aanpak van kinderarmoede, 2022). </li>
            </ul>

            <h5>In de omgeving</h5>
            <h6>Crises en technologische verschuivingen</h6>
            <p>Lager opgeleide mensen, behoren veel tot langdurige arme families, worden vaak onevenredig hard getroffen door crises, dit geldt ook voor technologische verschuivingen. Robots vervangen bijvoorbeeld veel fabrieksarbeiders. Hierdoor vinden lager opgeleide mensen moeilijker werk en hebben ze geen stabiel inkomen. </p>
            <ul>
