...
export default function Home() {
    return (
        <div className='container'>
            ...
            <a href="https://www.klasse.be/611298/gesprekstips-ouders-in-kansarmoede/?utm_medium=referral" target="_blank" rel="noopener noreferrer"><button className='btn btn-primary mb-3'>Artikel: Zo ga je het gesprek met ouders in kansarmoede aan </button></a>
            ...
            <a href="https://www.klasse.be/237640/armoedebeleid-school-dialoog-schoolboeken/?utm_medium=referral&utm_source=smartschool_be&utm_campaign=wel_dure_sneakers_geen_schoolboeken&utm_term=smartschool" target="_blank" rel="noopener noreferrer"><button className='btn btn-primary mb-3'>Artikel: Armoedebeleid: wel dure sneakers, geen geld voor schoolboeken? </button></a>

            <h6>Tools om rond kansarmoede te werken in de klas:</h6>
            <p>In de klas kan je armoede bespreekbaar maken met Jordy. Welzijnszorg biedt educatieve materialen aan om te werken in de klas rond kansarmoede. Je vindt er zowel educatieve als gratis materialen. Hieronder de link naar de website van Welzijnszorg, meerbepaald naar Jordy (kleuteronderwijs,z.d.).</p>
            <a href="https://welzijnszorg.be/jordy" target="_blank" rel="noopener noreferrer"><button className='btn btn-primary mb-3'>Jordy: Samen tegen armoede </button></a>
