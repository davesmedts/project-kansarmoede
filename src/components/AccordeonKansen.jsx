    ...
    return (
      <div>
        <Accordion open={open} toggle={toggle}>
          <AccordionItem>
            <AccordionHeader targetId="1">Generatiearmoede</AccordionHeader>
            ...
            <p>Er zijn verschillende domeinen die volgens onderzoek hierbij van belang zijn, het privé-domein, domein van werk en inkomen, ruimtelijk domein en het sociaal domein.</p>
            <ul>
                <li>Bij privé-domein gaat het om de overdracht van waarden, opvattingen en denkpatronen. Soms wordt het beeld van een gezinslid of familielid vertroebeld door overheersende geldzorgen. Je kan het gedachtenpatroon veranderen door kinderen, ouders en grootouders ervan bewust te maken van wat wel mogelijk is. Je kan hen samen begeleiden in deze keuzes. Zo krijgen nieuwe generaties de kans om werk en studie beter te benutten. De ondersteunende instanties moeten de focus leggen op mogelijkheden en kansen.  </li>
                <li>Binnen het domein werk en inkomen moeten er haalbare mogelijkheden zijn voor gezinsleden om hun werk en inkomenssituatie te verbeteren. Voor jonge ouders moet de combinatie werken en gezin haalbaar zijn. Er moet stabiliteit zijn in het inkomen, zo kunnen gezinnen voorkomen dat ze in een neerwaartse spiraal terecht komen. </li>
                ...
                <li>Het sociaal domein (inclusief initiatieven van onderop): Interventies op sociaal gebied kunnen de ongunstige sociale omgeving die ontstaat bij langdurige armoede ondervangen. Van belang daarbij zijn aandacht voor gezondheid, veerkracht en empowerment. Het onderwijs en kinderopvangvoorzieningen kunnen kinderen al jong vaardigheden als planning, focus op levensdoelen en controle bij verleidingen aanleren. Daarnaast hebben ze een rol in signalering van problemen. Initiatieven van onderop (burger, minima) helpen inzicht te verschaffen in wat er in de samenleving speelt (bijvoorbeeld hiaten in regelgeving of dienstverlening). Dergelijke initiatieven kunnen een verbindende rol spelen tussen formele organisaties en doelgroepen van beleid en ondersteuning. De inzet van opgeleide ervaringsdeskundigen helpt om inzichtelijk te maken wat het betekent om arm te zijn en de kloof tussen leefwereld en systeemwereld te overbruggen. (Sociaal domein: Niet herschreven) </li>
            </ul>
            <p>Door de combinatie van bovengenoemde domeinen met de mechanismen binnen het huishouden en in de omgeving komen we tot passende interventies.  </p>
            ...
            <p>De vroege kinderjaren zijn van groot belang. Voordat kinderen naar school gaan, worden de hersenstructuren gevormd. Deze leggen de basis voor de ontwikkeling op lange termijn alsook de kansen die iemand op volwassene leeftijd heeft.  </p>
            ...
            <p>Er is ook op vlak van familiestructuur veel te veranderen. Eenoudergezinnen hebben vaak te maken met generatiearmoede. Je kan het aantal éénoudergezinnen beperken door minder vaak mensen te laten scheiden en door tienermoederschap te voorkomen.  </p>
            <ul>
                <li>In privédomein kan er gewerkt met omgaan met conflicten. Hoogoplopende ruzies kunnen voorkomen worden en de gevolgen die nadelig zijn zoals stress en trauma’s hebben invloed op het aangaan van relaties in de toekomst. Hierbij kunnen we denken aan liefdesrelaties maar ook aan werkrelaties die verbetert kunnen worden. Hier leert men conflictsituaties niet te ontlopen en ontslag te nemen maar ze leren ermee opgaan en deze te hanteren. Het vergemakkelijkt carrièrestappen te maken en door deze weg kan langdurige armoede doorbroken worden.  </li>
                ...
                <li>Domein werk en inkomen kan zich inzetten om het voor éénoudergezinnen gemakkelijker te maken om het werken te kunnen combineren met de zorg van hun kinderen. Er kunnen mogelijkheden gecreërd worden om deeltijdsbanen met goede arbeidsvoorwaarden voor éénoudergezinnen.  </li>
                <li>Goede opvangmogelijkheden hoort daar ook bij, bij de werkgever of in de buurt. Dit heeft te maken met de ruimtelijk domein, infrastructuur. Het is ook van belang dat er een goede reisverbinding is tussen woonwerk en opvangplekken.  </li>
            </ul>
            ...
            <ul>
                ...
                <li>Bij het domein ruimtelijk is het belangrijk om een aantrekkelijke buitenruimte te creëren die uitnodigt tot spel en sport met leeftijdsgenoten. Ze maken vrienden en gaan bewegen. Dit voorkomt stress en gezondheidsklachten.  </li>
            </ul>

            <h5>Stress en daardoor minder doordacht omgaan met situaties: </h5>
            <p>Met geld omgaan kan voor gezinnen met generatiearmoede lastig zijn. Ze ervaren schaarste dat resulteert in een afname van de bandbreedte; het vermogen om beslissingen te nemen, aandacht op te brengen, vast te houden aan plannen en verleidingen te weerstaan.  </p>
            <p>Er zijn heel wat strategieën die helpen om stress te verminderen, een andere naam hiervoor is coping: </p>
            <ul>
            ...
            <ul>
                ...
                <li>Vanuit sociaal domein en privédomein wordt er aan emotiegericht coping gewerkt. Stress beter leren hanteren. De ondersteuning van stress-sensitieve dienstverlening is van belang, er wordt in de ondersteuning rekening gehouden met de inzichten uit de hersenwetenschap over de effecten van armoede op de vermogens van mensen. (Deze zin is letterlijk overgenomen).  </li>
                ...
                <li>Belangrijk en wat speelt in het ruimtelijk domein is de rol bij proactieve coping om stress te vinden. Buiten zijn en frisse lucht hebben, genieten van de natuur is heel belangrijk. Langdurige arme families zijn leven vaak in een wijk of gebied van generatie op generatie. Dit zijn vaak wijken die minder groen zijn. Een natuurspeelplaats voor kinderen is dan belangrijk om stress kwijt te kunnen en daar kunnen ze goed spelen. Een park om tot rust te komen door te wandelen heeft ook een positief effect op ouders en kinderen en verlaagd het stressniveau. Het zijn gratis activiteiten.  </li>
            </ul>
            ...
            <ul>
                ...
                <li>Vanuit sociaal domein is het belangrijk dat ervaringsdeskundigen proactief hulp bieden bij het bekomen van financiële ondersteuning. Ze kunnen helpen bij het invullen van formulieren en lezen van brieven waarop ze ook kunnen helpen met reageren. Dit kunnen brieven zijn van de gemeente of andere instanties. Ze kunnen een luisterend oor aanbieden voor mensen in een stressvol proces.  </li>
            </ul>
            ...
            <ul>
                <li>Bij het ruimtelijk domein dient er aandacht te zijn voor de inrichting van de wijken en buurt. Het moet aantrekkelijk zijn voor een diverse groep mensen. Ruimtelijke interventies moet vooral gericht zijn op het verminderen van ongelijkheid. De interventies moeten een combinatie zijn die gericht zijn op het verbeteren van de omgeving en die gericht zijn op de algemene ontwikkeling van het volk dat hiertoe gaan de meest optimale weg lijkt. Het kan nodig zijn om kinderen in arme wijken betere kansen te geven door ongelijk te investeren tussen wijken.  </li>
          ...
          <AccordionItem>
            <AccordionHeader targetId="3">Situationele armoede</AccordionHeader>
